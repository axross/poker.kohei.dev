...
import { ChevronRightLeftIcon } from "components/icons/chevron-right-left-icon";
...
import { FaceSmileIcon } from "components/icons/face-smile-icon";
...
import { SquaresPlusIcon } from "components/icons/squares-plus-icon";
...
const meta: Meta<typeof AnchorIcon> = {
  ...
  render: () => (
    <div className="flex flex-wrap gap-2">
      ...
      <ChevronRightLeftIcon className="h-5 w-5" />
      ...
      <NoResultsIcon className="h-5 w-5" />
